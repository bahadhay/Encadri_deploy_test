        ...
        public static async Task SeedDatabase(ApplicationDbContext context)
        {
            ...
            var users = new List<User>
            {
                new User
                {
                    ...
                    UserRole = "student",
                    AvatarUrl = "https://ui-avatars.com/api/?name=John+Student&background=4f46e5&color=fff",
                ...
                new User
                {
                    ...
                    FullName = "Dr. Sarah Supervisor",
                    UserRole = "supervisor",
                    AvatarUrl = "https://ui-avatars.com/api/?name=Sarah+Supervisor&background=4f46e5&color=fff",
                    PasswordHash = PasswordHasher.HashPassword("password123"),
                    CreatedDate = DateTime.UtcNow,
                    UpdatedDate = DateTime.UtcNow
                },
